...
class Rocket(pygame.sprite.Sprite):
    ...
    def __init__(self, speed, gravity_val=(0, 0.01), pos=(0, 0)):
        ...
        # self.gas_image = pygame.Surface(ROCKET_LAUNCHER_GAS_SIZE, flags=pygame.SRCALPHA)  # Crete surface for the rocket
        ...
        # gas_sprite = pygame.image.load(ROCKET_LAUNCHER_GAS_IMAGE).convert_alpha()
        # gas_sprite = pygame.transform.scale(gas_sprite, self.gas_image.get_size())

        self.image.blit(sprite, (0, 0))  # Fill surface with image
        # self.gas_image.blit(gas_sprite, (0, 0))
